...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('purchase.address.update', ['item_id' => $item->id])); ?>" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="zip_code" class="zip-code" id="zip_code" value="<?php echo e(old('zip_code', $defaultAddress['zip_code'])); ?>" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="address" class="address" id="address" value="<?php echo e(old('address', $defaultAddress['address'])); ?>" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="building" class="building" id="building" value="<?php echo e(old('building', $defaultAddress['building'])); ?>">
